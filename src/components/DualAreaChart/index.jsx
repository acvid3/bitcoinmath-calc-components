...
const DualAreaChart = (props) => {
    ...
    const chartItems = [
        ...
        { label: `Income + Bitcoin: ${chartData[chartData.length - 1].income_plus_bitcoin}`, color: '#F1B314' },
    ];
        ...
        >
            <ResponsiveContainer width="100%" height="100%">
                ...
                <AreaChart data={chartData} margin={{ top: 10, right: 20, left: -10, bottom: 0 }}>
                    ...
                    <Area type="monotone" dataKey="annual_income" stroke="#2E4E35" strokeWidth={2} fill="url(#colorStandard)" />
                    <Area type="monotone" dataKey="income_plus_bitcoin" stroke="#F1B314" strokeWidth={2} fill="url(#colorBTC)" />
                </AreaChart>
            </ResponsiveContainer>
        </Box>
    );
