export const resultsDescriptions = [
    { description: "50% less cash down in order to buy BTC", label: "Amount down" },
    ...
    { description: "The purchased BTC's value when the term ends", label: "Ending term value" },
    ...
    { description: "The difference % between the two scenarios (BTC - Tradfi)", label: "Difference $" },
    { description: "The difference multiple between the two scenarios (BTC / Tradfi)", label: "Difference" }
];
