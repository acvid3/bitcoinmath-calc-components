export const inputFields = [
    { id: 'car_price', label: 'Car Price ($)', placeholder: 'Enter car price', message: 'What is the price of the car?' },
    ...
    { id: 'btc_price', label: 'BTC Price ($)', placeholder: 'Enter BTC price', message: '' },
];
