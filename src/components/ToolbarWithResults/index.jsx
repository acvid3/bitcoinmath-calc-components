    ...
    return (
        <Box sx={{
            ...
            <Box>
                ...
                <Typography sx={primaryTextStyles}>${results?.comparison?.difference_dollar || 0}</Typography>
            </Box>
            <Box>
                <Typography sx={labelStyles}>Difference %</Typography>
                <Typography sx={primaryTextStyles}>{results?.comparison?.difference_percent || '0%'}</Typography>
            </Box>
