    ...
    return (
        <Box sx={sx.container}>
            ...
            <Box>
                ...
                <Typography sx={sx.primaryText}>${formatNumber(results?.data?.difference?.dollar) || 0}</Typography>
            </Box>
            <Box>
                <Typography sx={sx.label}>Difference %</Typography>
                <Typography sx={sx.primaryText}>{formatNumber(results?.data?.difference?.percent) || 0}%</Typography>
            </Box>
            <Box>
                <Typography sx={sx.label}>Multiple</Typography>
                <Typography sx={sx.primaryText}>{formatNumber(results?.data?.difference?.multiple) || 0}</Typography>
            </Box>
