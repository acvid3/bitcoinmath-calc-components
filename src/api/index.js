...
export const calculateHomePurchaseData = async (data) => {
...
export const calculateCollegeSavings = async (data) => {
    try {
        const apiUrl = 'http://13.61.153.104/wp-json/btc-calculator/v1/calculate-college-savings';
